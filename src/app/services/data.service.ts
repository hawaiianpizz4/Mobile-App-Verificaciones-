...
export class dataService {
  ...
  getListaClientesRefi() {
    return this._http.get<any>(
      `http://171.23.12.100/api_rest_movil/controller/refinanciamiento.php?op=getClientes`
      // `http://171.23.12.90/api_rest_movil/controller/refinanciamiento.php?op=getClientes`
    );
  }

  getDatosCliente(id: string) {
    return this._http.get<any>(
      `http://171.23.12.100/api_rest_movil/controller/refinanciamiento.php?op=getClientesId&id=${id}`
      // `http://171.23.12.90/api_rest_movil/controller/refinanciamiento.php?op=getClientes`
    );
  }
}
